...
(Frans-Canadees) of C<-865> (Scandinavisch). Windows codetabel CP1252 (Westers)
wordt ook ondersteund met optie C<-1252>. Gebruik voor andere codetabellen
dos2unix in combinatie met iconv(1). Iconv kan omzetten tussen een lange lijst
letterteken-coderingen.
