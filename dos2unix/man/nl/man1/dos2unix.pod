...
=head1 OVERZICHT
    ...
    dos2unix [opties] [BESTAND ...] [-n BESTAND-IN BESTAND-UIT ...]
    unix2dos [opties] [BESTAND ...] [-n BESTAND-IN BESTAND-UIT ...]
...
Dos2unix is gemodelleerd naar dos2unix onder SunOS/Solaris en heeft een aantal gelijke conversiemodi.
...
Conversie tussen DOS en ISO lettertekenreeks. Zie ook paragraaf
CONVERSIE MODI.

=item B<-1252>

Gebruik Windows codetabel 1252.

=item B<-437>

Gebruik DOS codetabel 437. Dit is de standaard codetabel die gebruikt wordt bij ISO conversie.

=item B<-850>

Gebruik DOS codetabel 850.
...
Lettertekens worden omgezet tussen een DOS lettertekenreeks (codetabel)
en ISO lettertekenreeks ISO-8859-1 op Unix. DOS lettertekens zonder gelijkwaardig ISO-8859-1
teken, waarvoor geen omzetting mogelijk is, worden omgezet in een punt. Het zelfde
geldt voor ISO-8859-1 tekens zonder DOS tegenhanger.

De standaard DOS codetabel die gebruikt wordt is CP437, die met name in
de VS gebruikt word. In West Europa is CP850 meer gebruikelijk. Windows
codetabel 1252 wordt ook ondersteund. Gebruik voor andere codetabellen
dos2unix in combinatie met iconv(1). Iconv kan omzetten tussen
een lange lijst letterteken-coderingen.

Enkele voorbeelden:

Omzetten van DOS CP437 naar Unix Latin-1
...
Omzetten van Unix Latin-1 naar DOS CP437
