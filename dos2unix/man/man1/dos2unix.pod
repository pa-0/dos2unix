...
Use Windows code page 1252 (Western).
...
The default DOS code page used is CP437, which is mainly used in the USA.
Additionally dos2unix supports DOS code pages CP850 (Western European), CP860
(Portuguese), CP863 (French Canadian), and CP865 (Nordic).  Windows code page
CP1252 (Western) is also supported. For other code pages use dos2unix in
