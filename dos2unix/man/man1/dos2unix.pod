...
Use DOS code page 863 (Canadian French).
...
C<-437> (US), C<-850> (Western European), C<-860> (Portuguese), C<-863> (Canadian
French), or C<-865> (Nordic).  Windows code page CP1252 (Western) is also
supported with option C<-1252>. For other code pages use dos2unix in
