...
dist:
	...
	cd ../$(RELEASE_DIR_D2U) ; unix2dos --keepdate man/nonlatin/man1/*.txt man/*/man1/*.txt
	cd ../$(RELEASE_DIR_D2U) ; unix2dos --keepdate man/nonlatin/man1/*.pod man/*/man1/*.pod
	cd ../$(RELEASE_DIR_D2U) ; unix2dos --keepdate man/nonlatin/man1/*.htm* man/*/man1/*.htm*
